...
class EthereumConnector extends ConnectorBase {
    ...
    async _sendSingleRequest(request) {
        ...
        request.contract = request.contractId;
        request.verb = request.contractFunction;
        request.args = request.contractArguments
